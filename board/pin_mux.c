...
- pin_list:
  ...
  - {pin_num: '46', peripheral: PORTC, signal: 'port, 14', pin_signal: PTC14, direction: INPUT}
  - {pin_num: '29', peripheral: PORTC, signal: 'port, 3', pin_signal: PTC3, direction: INPUT}
  - {pin_num: '94', peripheral: LPSPI0, signal: 'sck, sck', pin_signal: PTE0, direction: OUTPUT}
  - {pin_num: '93', peripheral: LPSPI0, signal: sin, pin_signal: PTE1, direction: INPUT}
  - {pin_num: '85', peripheral: LPSPI0, signal: sout, pin_signal: PTE2, direction: OUTPUT}
  - {pin_num: '84', peripheral: LPSPI0, signal: 'pcs, 2', pin_signal: PTE6, direction: OUTPUT}
